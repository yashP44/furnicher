...
const Header = () => {
    ...
    return (
        <>
            <section className='w-full glass-head'>
                <nav className='w-full flex flex-col justify-around lg:h-[100px] lg:flex lg:flex-row lg:items-center lg:justify-between px-[5%]'>
                    ...
                    <ul className={`${!open ? 'flex ' : 'hidden '} items-center flex-col gap-16 px-5 my-10 lg:my-0 lg:p-0 lg:flex lg:flex-row lg:gap-10`}>
                        ...
                        <li >
                            <Link className={` ${splitLocation[1] === "contact" ? "text-[#B88E2F] text-[18px] font-light duration-500 text-base  cursor-pointer" : ""}`} to='/contact'>Contact</Link>
                        </li>
                        <li >
                            <Link className={` ${splitLocation[1] === "blog" ? "text-[#B88E2F] text-[18px] font-light duration-500 text-base  cursor-pointer" : ""}`}
                                to='/blog' >Blog</Link>
                        </li>
                    </ul>
                    <hr className={`${!open ? 'flex' : 'hidden'} h-2 w-full text-[#e5e7eb] my-2 lg:hidden`} />
